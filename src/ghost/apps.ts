export type AppId =
  | "games" | "movies" | "music" | "ghostai" | "browser" | "discover" | "ghostcloud"
  | "x" | "tiktok" | "pinterest"
...
export const APPS: AppDef[] = [
  { id: "games",      name: "Games",      icon: "▣", accent: "from-fuchsia-500 via-pink-500 to-rose-600", description: "Arcade & cloud" },
  ...
  { id: "chat",       name: "Chat",       icon: "✉", accent: "from-sky-400 to-indigo-700",               description: "Encrypted chat" },
