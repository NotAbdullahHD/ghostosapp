...
export const APPS: AppDef[] = [
  ...
  { id: "ghostai",    name: "Ghost Assistant", icon: "✦", accent: "from-zinc-800 to-zinc-900", description: "Built-in assistant" },
  ...
  { id: "music",      name: "Ghost Music", icon: "♪", accent: "from-zinc-800 to-zinc-900", description: "Music player" },
