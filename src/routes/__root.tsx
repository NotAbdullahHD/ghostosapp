...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GhostOS" },
      { name: "description", content: "GhostOS is a cinematic, browser-based operating system with a futuristic, cyberpunk aesthetic." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "GhostOS" },
      { property: "og:description", content: "GhostOS is a cinematic, browser-based operating system with a futuristic, cyberpunk aesthetic." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.cdnfonts.com/css/ethnocentric" },
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500&family=Montserrat:wght@600&family=Syncopate:wght@400;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
